...
router.post('/cv', upload.single('cv'), async (req, res) => {
    ...
    try {
        ...
        const question = `Give me the next details: email,role , company ,experience and skills in the CV: ${text.text}  (give me the answer as a list)`;
...
router.post('/createuser', async (req, res) => {
    ...
    const signOut = userService.createUser(req.body);
 });
